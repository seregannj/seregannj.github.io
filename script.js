...
var T={
  ru:{
    ...
    pc1_title:'Telegram Notes Bot',pc1_desc:'Бот на Python с aiogram и SQLite — заметки, теги, поиск.',
    pc2_title:'IoT Dashboard',pc2_desc:'React-интерфейс для умного дома: графики, сценарии, REST API.',
    pc3_title:'Weather API',pc3_desc:'FastAPI-сервис погоды с Redis-кэшем и rate-limit.',
    pc4_title:'Task Tracker',pc4_desc:'Трекер задач на React + LocalStorage. Drag & drop, фильтры.',
    pc5_title:'Markdown Editor',pc5_desc:'Редактор Markdown с подсветкой и экспортом в HTML/PDF.',
    pc6_title:'Telegram Bot Template',pc6_desc:'Шаблон Python-бота с Docker, logging и admin-панелью.',
    pc7_title:'Smart Home Docs',pc7_desc:'Тех. документация IoT-системы: API, сценарии, архитектура.',
    pc8_title:'Analytics Service',pc8_desc:'Сервис аналитики на Python: события, дашборд, экспорт CSV.',
    footer_phrases:[
  ...
  en:{
    ...
    link_github:'GitHub',link_demo:'Demo',
    pc1_title:'Telegram Notes Bot',pc1_desc:'Python bot with aiogram and SQLite — notes, tags, search.',
    pc2_title:'IoT Dashboard',pc2_desc:'React interface for smart home: charts, scenarios, REST API.',
    pc3_title:'Weather API',pc3_desc:'FastAPI weather service with Redis cache and rate-limit.',
    pc4_title:'Task Tracker',pc4_desc:'React + LocalStorage task tracker. Drag & drop, filters.',
    pc5_title:'Markdown Editor',pc5_desc:'Markdown editor with syntax highlighting and HTML/PDF export.',
    pc6_title:'Telegram Bot Template',pc6_desc:'Python bot template with Docker, logging and admin panel.',
    pc7_title:'Smart Home Docs',pc7_desc:'Tech docs for IoT system: API, scenarios, architecture.',
    pc8_title:'Analytics Service',pc8_desc:'Python analytics service: events, dashboard, CSV export.',
    footer_phrases:[
